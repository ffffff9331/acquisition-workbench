...
function Preview() {
  const [data, setData] = useState<TopicResearchData>({
    ...
    generatedTopics: [{
      id: 'fixture-traffic-campaign',
      industryPackId: '',
      tacticPackId: '',
      title: '旧卫生间换智能马桶，先判断 4 个安装条件',
      customerQuestion: '旧卫生间能不能直接换智能马桶，会不会因为坑距和电源返工？',
      targetCustomer: '准备翻新老房卫生间、担心买错尺寸的成都业主',
      buyerStage: '方案比较',
      demandSignal: '两条公开来源都反复出现坑距、电源位置和开门空间冲突。',
      contentAngle: '用真实量尺顺序讲清四个安装条件，并展示一组不能直接安装的反例。',
      keyPromise: '客户看完可以先完成基础自查，减少买后返工。',
      proofNeeded: '真实量尺画面、尺寸标注、安装前后案例；不使用未授权客户信息。',
      callToAction: '私信户型和四个尺寸，预约人工初步判断。',
      leadMagnet: '旧卫生间智能马桶安装自查表',
      recommendedChannels: ['douyin', 'xiaohongshu'],
      trafficMode: '主动需求截流',
      testWindowDays: 7,
      successSignal: '7 天内记录有效咨询、完成首次人工承接和进入到店或量尺的人数，不只看播放量。',
      campaignStatus: '执行准备中',
      campaignOwner: '',
      campaignStartedAt: '',
      campaignEndsAt: '',
      campaignNote: '',
      ...
      fitReason: '问题接近购买决策，门店可以用量尺和案例提供真实证明。',
      evidenceIds: ['fixture-source', 'fixture-source-2'],
      service: 'official',
      status: '待评估',
      adoptedChannels: ['douyin'],
      adoptions: [{ channelId: 'douyin', itemId: 'fixture-douyin-item', adoptedAt: '2026-09-08T09:35:00+08:00' }],
      reviewDecision: '',
      createdAt: '2026-09-08T09:30:00+08:00',
    }],
  })
